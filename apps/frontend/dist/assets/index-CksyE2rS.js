(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}})();const Te="/api",E={async get(t){const e=await fetch(`${Te}${t}`);if(!e.ok){const n=await e.json().catch(()=>({}));throw new Error(n.error||`HTTP error! status: ${e.status}`)}return await e.json()},async post(t,e){const n=await fetch(`${Te}${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!n.ok){const o=await n.json().catch(()=>({}));throw new Error(o.error||`HTTP error! status: ${n.status}`)}return await n.json()},async put(t,e){const n=await fetch(`${Te}${t}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!n.ok){const o=await n.json().catch(()=>({}));throw new Error(o.error||`HTTP error! status: ${n.status}`)}return await n.json()},async delete(t){const e=await fetch(`${Te}${t}`,{method:"DELETE"});if(!e.ok){const n=await e.json().catch(()=>({}));throw new Error(n.error||`HTTP error! status: ${e.status}`)}return await e.json()},async upload(t,e){const n=await fetch(`${Te}${t}`,{method:"POST",body:e});if(!n.ok){const o=await n.json().catch(()=>({}));throw new Error(o.error||`HTTP error! status: ${n.status}`)}return await n.json()}};let we=null;const Z={init(){const t=localStorage.getItem("user");if(t)try{return we=JSON.parse(t),!0}catch{return this.logout(),!1}return!1},getUser(){return we},isAdmin(){return we&&we.role==="Administrador"},async login(t,e){try{const n=await E.post("/login",{email:t,password:e});return we=n,localStorage.setItem("user",JSON.stringify(n)),{success:!0,user:n}}catch(n){return{success:!1,error:n.message}}},logout(){we=null,localStorage.removeItem("user")}},c={show(t){const e=document.getElementById(t);e&&e.classList.remove("hidden")},hide(t){const e=document.getElementById(t);e&&e.classList.add("hidden")},toggle(t,e){const n=document.getElementById(t);n&&n.classList.toggle("hidden",e)},setText(t,e){const n=document.getElementById(t);n&&(n.innerText=e)},setValue(t,e){const n=document.getElementById(t);n&&(n.value=e)},getValue(t){const e=document.getElementById(t);return e?e.value:null},on(t,e,n){const o=document.getElementById(t);o&&o.addEventListener(e,n)}},Lt={canvas:null,ctx:null,particles:[],animationFrameId:null,isActive:!1,init(){if(this.canvas=document.getElementById("account-network-bg"),!this.canvas)return;this.ctx=this.canvas.getContext("2d"),this.resize(),window.addEventListener("resize",()=>{this.isActive&&this.resize()});const t=window.innerWidth<=768;this.particleCount=t?30:60,this.connectDistance=150,this.particleColor="rgba(34, 211, 238, 0.5)",this.particles=[];for(let e=0;e<this.particleCount;e++)this.particles.push({x:Math.random()*this.canvas.width,y:Math.random()*this.canvas.height,vx:(Math.random()-.5)*1.5,vy:(Math.random()-.5)*1.5,radius:Math.random()*2+1})},resize(){if(!this.canvas)return;const t=document.getElementById("account-section");t&&(this.canvas.width=t.clientWidth,this.canvas.height=t.clientHeight)},updateAndDraw(){if(!(!this.isActive||!this.canvas)){this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);for(let t=0;t<this.particles.length;t++){const e=this.particles[t];e.x+=e.vx,e.y+=e.vy,(e.x<0||e.x>this.canvas.width)&&(e.vx*=-1),(e.y<0||e.y>this.canvas.height)&&(e.vy*=-1),this.ctx.beginPath(),this.ctx.arc(e.x,e.y,e.radius,0,Math.PI*2),this.ctx.fillStyle=this.particleColor,this.ctx.fill();for(let n=t+1;n<this.particles.length;n++){const o=this.particles[n],i=e.x-o.x,s=e.y-o.y,a=Math.sqrt(i*i+s*s);if(a<this.connectDistance){this.ctx.beginPath(),this.ctx.lineWidth=1;const r=1-a/this.connectDistance;this.ctx.strokeStyle=`rgba(34, 211, 238, ${r*.4})`,this.ctx.moveTo(e.x,e.y),this.ctx.lineTo(o.x,o.y),this.ctx.stroke()}}}this.animationFrameId=requestAnimationFrame(()=>this.updateAndDraw())}},start(){this.canvas||this.init(),this.isActive||(this.isActive=!0,this.resize(),this.updateAndDraw())},stop(){this.isActive=!1,this.animationFrameId&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null)}};let Le=[];const xt={async fetch(){try{Le=await E.get("/users"),this.render(Le)}catch(t){console.error("Error fetching Users:",t)}},getUsers(){return Le},render(t){const e=document.getElementById("user-table-body");e&&(e.innerHTML=t.map(n=>{const o=n.role==="Administrador",i=Z.isAdmin()?`
            ...
            `}).join("")},render(t){const e=document.getElementById("doc-list-body");if(!e)return;const n=document.getElementById("doc-list-thead"),o=me.toLowerCase()==="contratos"||me.toLowerCase()==="termo de uso",i=window.auth&&window.auth.isAdmin(),s=i?"":'class="role-hidden"';St=t;const a=t.length,r=Math.ceil(a/Se);W>r&&(W=Math.max(1,r)),W<1&&(W=1);const l=(W-1)*Se,d=t.slice(l,l+Se);if(n&&(o?n.innerHTML=`
                    <tr>
                        <th>Nome</th>
                        <th>Tamanho</th>
                        <th>Tipo</th>
        ...
        `;const a=(W-1)*Se+1,r=Math.min(W*Se,n);i+=`
            <span class="pagination-info">
                Exibindo ${a}-${r} de ${n}
            </span>
        `,o.innerHTML=i}};let ue=[],S={summaries:[]},Dt=null,j=null,dt="list",De=null,de=null,At=null,J=1;const Ae=10;let Ye=[];const ee={getPendingProcId(){return Dt},async fetch(){try{J=1,ue=await E.get("/procedures"),this.renderTable(ue)}catch(t){console.error("Error fetching FAQs:",t)}},getFaqs(){return ue},setListingMode(t){dt=t,J=1,this.renderTable(Ye.length?Ye:ue)},renderTable(t){const e=document.getElementById("list-table-container"),n=document.getElementById("list-cards-container"),o=document.getElementById("proc-table-body");if(!e||!n||!o)return;Ye=t;const i=t.length,s=Math.ceil(i/Ae);J>s&&(J=Math.max(1,s)),J<1&&(J=1);const a=(J-1)*Ae,r=t.slice(a,a+Ae);dt==="list"?(c.show("list-table-container"),c.hide("list-cards-container"),r.length===0?o.innerHTML=`
                    <tr>
...
Descrição: ${h.descricao||"-"}`),!h.fim&&_.classList.add("pulsing"),window.auth&&window.auth.isAdmin()?(_.style.cursor="pointer",_.onclick=R=>{R.stopPropagation(),It(h.id)}):_.style.cursor="default",D.appendChild(_),v.appendChild(D)})})}function Oe(t){return t?t.toLowerCase().trim():""}function en(t,e,n,o){const i=document.getElementById(`sla-${t}`);if(!i)return;const s=o-n;if(s<=0){i.textContent="N/A";return}const r=e.filter(p=>{const f=new Date(p.inicio).getTime();return(p.fim?new Date(p.fim).getTime():Date.now())>n&&f<o}).map(p=>({start:Math.max(new Date(p.inicio).getTime(),n),end:Math.min(p.fim?new Date(p.fim).getTime():Date.now(),o)}));r.sort((p,f)=>p.start-f.start);const l=[];if(r.length>0){let p=r[0];for(let f=1;f<r.length;f++){const m=r[f];m.start<p.end?p.end=Math.max(p.end,m.end):(l.push(p),p=m)}l.push(p)}let d=0;l.forEach(p=>{d+=p.end-p.start});const u=(s-d)/s*100;let g="#10b981";u<50?g="#ef4444":u<90&&(g="#f97316"),i.style.color=g,i.textContent=u.toFixed(4)+"%"}function jt(){const t=document.getElementById("attention-topics-container");if(!t)return;t.innerHTML="";const e=be.filter(n=>!n.fim);oe.forEach(n=>{const o=n.id,i=e.filter(v=>Oe(v.topico)===o),s=document.createElement("div");s.className=i.length>0?"accordion-item active":"accordion-item",s.id=`attn-acc-${o}`;const a=document.createElement("div");a.className="accordion-header",a.onclick=()=>qt(`attn-acc-${o}`);const r=document.createElement("div");r.className="accordion-title-group";const l=document.createElement("div");l.className="topic-indicator",l.style.backgroundColor=n.color;const d=document.createElement("h3");d.textContent=n.name;const u=document.createElement("span");u.style.cssText="background: #f1f5f9; padding: 2px 8px; border-radius: 12px; font-size: 0.95rem; font-weight: 900; color: #0f172a; margin-left: 0.5rem; border: 1px solid #cbd5e1;",u.textContent=`${i.length}`,r.appendChild(l),r.appendChild(d),r.appendChild(u);const g=document.createElement("span");g.className="accordion-chevron",g.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" /></svg>',a.appendChild(r),a.appendChild(g);const p=document.createElement("div");p.className="accordion-content";const f=document.createElement("div");f.className="accordion-body";const m=document.createElement("div");if(m.className="attention-carousel",i.length===0){const v=document.createElement("div");v.className="empty-state",v.textContent="Nenhum evento em andamento.",m.appendChild(v)}else i.forEach(v=>{const h=document.createElement("div");h.className="attention-card",h.style.borderLeftColor=v.cor&&v.cor!=="#000000"?v.cor:n.color;const k=document.createElement("h3");k.textContent=v.nome;const I=document.createElement("div");I.className="sub-topic",I.textContent=v.sub_topico||"-";const x=document.createElement("div");x.className="card-detail",x.innerHTML=`<strong>Início:</strong> ${new Date(v.inicio).toLocaleString()}`;const w=Date.now()-new Date(v.inicio).getTime(),$=document.createElement("div");$.className="card-duration",$.innerHTML=`<strong>Tempo:</strong> <span>${tn(w)}</span>`;const b=document.createElement("div");b.className="card-description",b.textContent=v.descricao||"-",h.appendChild(k),h.appendChild(I),h.appendChild(x),h.appendChild($),h.appendChild(b),window.auth&&window.auth.isAdmin()?(h.style.cursor="pointer",h.onclick=()=>It(v.id)):h.style.cursor="default",m.appendChild(h)});f.appendChild(m),p.appendChild(f),s.appendChild(a),s.appendChild(p),t.appendChild(s)})}function tn(t){if(t<0)return"0s";const e=Math.floor(t/1e3),n=Math.floor(e/60),o=Math.floor(n/60),i=Math.floor(o/24),s=[];return i>0&&s.push(`${i}d`),(o%24>0||i>0)&&s.push(`${o%24}h`),(n%60>0||o>0)&&s.push(`${n%60}m`),s.push(`${e%60}s`),s.join(" ")}function nn(t){const e=document.getElementById("rep-filter-subtopic");if(!e)return;e.innerHTML='<option value="Todos">Todos</option>';const n=t?t.toLowerCase().trim():"";n&&le[n]&&le[n].forEach(o=>{const i=document.createElement("option");i.value=o.toLowerCase(),i.textContent=o,e.appendChild(i)})}function Fe(){let t=be;const e=document.getElementById("rep-filter-start")?.value,n=document.getElementById("rep-filter-end")?.value,o=document.getElementById("rep-filter-topic")?.value,i=document.getElementById("rep-filter-subtopic")?.value;if(e){const b=new Date(e+"T00:00:00").getTime();t=t.filter(D=>new Date(D.inicio).getTime()>=b)}if(n){const b=new Date(n+"T23:59:59").getTime();t=t.filter(D=>new Date(D.inicio).getTime()<=b)}o&&o!=="Todos"&&(t=t.filter(b=>Oe(b.topico)===o.toLowerCase())),i&&i!=="Todos"&&(t=t.filter(b=>b.sub_topico&&b.sub_topico.toLowerCase()===i.toLowerCase()));const s=document.getElementById("rep-kpi-total"),a=document.getElementById("rep-kpi-active"),r=document.getElementById("rep-kpi-avg-time");s&&(s.textContent=t.length);const l=t.filter(b=>b.em_ocorrencia==1||b.em_ocorrencia==="true"||!b.fim);a&&(a.textContent=l.length);const d=t.filter(b=>b.fim);let u="0h 0m";if(d.length>0){const D=d.reduce((q,U)=>q+(new Date(U.fim).getTime()-new Date(U.inicio).getTime()),0)/d.length,B=Math.floor(D/6e4),_=Math.floor(B/60),V=B%60;u=`${_}h ${V}m`}if(r&&(r.textContent=u),!window.Chart){console.warn("Chart.js is not loaded.");return}const g=oe,p=e?new Date(e+"T00:00:00").getTime():new Date(new Date().getFullYear()+"-01-01T00:00:00").getTime(),f=n?new Date(n+"T23:59:59").getTime():Date.now(),m=g.map(b=>b.name),v=g.map(b=>{const D=b.id,B=be.filter(y=>Oe(y.topico)===D),_=f-p;if(_<=0)return 100;const q=B.filter(y=>{const C=new Date(y.inicio).getTime();return(y.fim?new Date(y.fim).getTime():Date.now())>p&&C<f}).map(y=>({start:Math.max(new Date(y.inicio).getTime(),p),end:Math.min(y.fim?new Date(y.fim).getTime():Date.now(),f)}));q.sort((y,C)=>y.start-C.start);const U=[];if(q.length>0){let y=q[0];for(let C=1;C<q.length;C++){const L=q[C];L.start<y.end?y.end=Math.max(y.end,L.end):(U.push(y),y=L)}U.push(y)}const F=(y=>{let C=0;return y.forEach(L=>{C+=L.end-L.start}),C})(U),R=(_-F)/_*100;return parseFloat(R.toFixed(4))}),h=g.map(b=>b.color||"#6b7280"),k=document.getElementById("chart-rep-sla");k&&(ct&&ct.destroy(),ct=new window.Chart(k,{type:"bar",data:{labels:m,datasets:[{label:"Disponibilidade %",data:v,backgroundColor:h,borderRadius:6}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{y:{min:Math.max(0,Math.min(...v)-5),max:100,ticks:{callback:b=>b+"%"}}}}}));const I={};t.forEach(b=>{const D=b.sub_topico?b.sub_topico.charAt(0).toUpperCase()+b.sub_topico.slice(1).toLowerCase():"Não especificado";I[D]=(I[D]||0)+1});const x=Object.keys(I),w=Object.values(I),$=document.getElementById("chart-rep-qty");$&&(ut&&ut.destroy(),ut=new window.Chart($,{type:"doughnut",data:{labels:x.length>0?x:["Nenhum evento"],datasets:[{data:w.length>0?w:[0],backgroundColor:["#3b82f6","#10b981","#f59e0b","#8b5cf6","#ec4899","#6366f1","#14b8a6","#f43f5e","#a855f7","#06b6d4"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{boxWidth:12}}}}}))}function on(t){if(t.preventDefault(),He)return;He=!0;const e=document.getElementById("topic-id"),n=document.getElementById("topic-name"),o=document.getElementById("topic-color");if(!e||!n||!o){He=!1;return}const i={id:e.value.trim().toLowerCase(),name:n.value.trim(),color:o.value};if(!i.id){alert("Por favor, defina um ID para o tópico."),He=!1;return}fetch("/api/timeline/config/topics",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)}).then(s=>{if(!s.ok)throw new Error("Erro ao salvar tópico");return s.json()}).then(()=>(alert("Tópico salvo com sucesso!"),e.value="",n.value="",o.value="#3b82f6",xe().then(()=>{ce()}))).catch(s=>{console.error(s),alert("Erro: "+s.message)}).finally(()=>{He=!1})}function an(t){if(t.preventDefault(),Re)return;Re=!0;const e=document.getElementById("subtopic-topic-id"),n=document.getElementById("subtopic-name");if(!e||!n){Re=!1;return}const o={topic_id:e.value,name:n.value.trim()};if(!o.topic_id||!o.name){alert("Preencha todos os campos do evento."),Re=!1;return}fetch("/api/timeline/config/subtopics",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(o)}).then(i=>{if(!i.ok)throw new Error("Erro ao adicionar evento");return i.json()}).then(()=>(alert("Evento adicionado!"),n.value="",xe())).catch(i=>{console.error(i),alert("Erro: "+i.message)}).finally(()=>{Re=!1})}function sn(t){confirm("Excluir este tópico também removerá todos os seus eventos associados. Deseja continuar?")&&fetch(`/api/timeline/config/topics/${t}`,{method:"DELETE"}).then(e=>{if(!e.ok)throw new Error("Erro ao excluir tópico");return e.json()}).then(()=>{alert("Tópico excluído!"),xe().then(()=>{ce()})}).catch(e=>{console.error(e),alert("Erro: "+e.message)})}function rn(t){confirm("Deseja realmente excluir este evento?")&&fetch(`/api/timeline/config/subtopics/${t}`,{method:"DELETE"}).then(e=>{if(!e.ok)throw new Error("Erro ao excluir evento");return e.json()}).then(()=>{alert("Evento excluído!"),xe()}).catch(e=>{console.error(e),alert("Erro: "+e.message)})}function Gt(){const t=document.getElementById("config-topics-list");t&&(t.innerHTML="",oe.length===0?t.innerHTML='<div style="color: var(--text-muted); font-size: 0.9rem;">Nenhum tópico cadastrado.</div>':oe.forEach(n=>{const o=document.createElement("div");o.style.cssText="display: flex; align-items: center; justify-content: space-between; padding: 10px; background: rgba(255,255,255,0.05); border-radius: 8px; border: 1px solid var(--glass-border); margin-bottom: 6px;",o.innerHTML=`
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: flex; align-items: center; justify-content: space-between; gap: 10px; min-width: 140px;">
                            ...
                            <button class="btn-icon" onclick="window.TelephonyHandler.toggleSecret(${n.id}, '${g}')" title="Mostrar/Ocultar Senha" style="padding: 4px; width: 28px; height: 28px; display: flex; align-items: center; justify-content: center;">
        ...
        `,o.innerHTML=i},init(){console.log("📞 [TELEFONIA] Inicializando telephonyHandler...");const t=document.getElementById("telephony-history-start"),e=document.getElementById("telephony-history-end");t&&(t.value=""),e&&(e.value=""),["telephony-history-start","telephony-history-end"].forEach(o=>{const i=document.getElementById(o);i&&i.addEventListener("change",()=>this.fetchAndRenderHistory())}),["telephony-history-exten","telephony-history-username"].forEach(o=>{const i=document.getElementById(o);i&&i.addEventListener("input",()=>this.fetchAndRenderHistory())});const n=document.getElementById("btn-clear-telephony-history-filters");n&&n.addEventListener("click",()=>{t&&(t.value=""),e&&(e.value="");const o=document.getElementById("telephony-history-exten"),i=document.getElementById("telephony-history-username");o&&(o.value=""),i&&(i.value=""),this.fetchAndRenderHistory()})},async fetchAndRenderHistory(){const t=document.getElementById("telephony-history-timeline-container");t&&(t.innerHTML=`
                <div style="text-align: center; padding: 3rem; color: var(--text-muted); width: 100%;">
                    Carregando histórico...
                </div>
            `);try{const e=document.getElementById("telephony-history-start")?.value||"",n=document.getElementById("telephony-history-end")?.value||"",o=document.getElementById("telephony-history-exten")?.value||"",i=document.getElementById("telephony-history-username")?.value||"",s=new URLSearchParams({startDate:e,endDate:n,exten:o,username:i}),a=await E.get("/telephony/extensions/history?"+s.toString());this.renderHistoryTimeline(a)}catch(e){console.error("Error fetching extension history:",e),t&&(t.innerHTML=`
            ...
            `;return}e.innerHTML=t.map(n=>{const o=new Date(n.changed_at).toLocaleString("pt-BR"),i=n.exten||"-",s=n.old_username||"<i>(Vazio)</i>",a=n.new_username||"<i>(Removido)</i>",r=n.changed_by||"Sistema";return`
                <div class="timeline-item" style="position: relative; padding-bottom: 10px;">
                    ...
                    <div class="glass" style="padding: 15px; border-radius: 8px; border: 1px solid var(--glass-border); background: rgba(255,255,255,0.02);">
                        ...
                        <div style="font-size: 0.9rem; color: var(--text-main); margin-bottom: 8px;">
                             ...
                             <strong style="color: var(--success, #10b981);">${a}</strong>
                         </div>
        ...
        `,R=0;D.forEach(y=>{const C=y.status==="active"||y.status_label==="ativo",L=C?"#10b981":"#ef4444",P=C?"Online":y.status_label||y.status||"Offline",z=C?"rgba(16,185,129,0.12)":"rgba(239,68,68,0.12)",N=C?"#6ee7b7":"#fca5a5",K=C?"rgba(16,185,129,0.3)":"rgba(239,68,68,0.3)",Ge=R%2===0?"transparent":"rgba(255,255,255,0.015)";R++,F+=`
                ...
                </div>`}),_.forEach(y=>{let C="#10b981",L="Online",P="rgba(16,185,129,0.12)",z="#6ee7b7",N="rgba(16,185,129,0.3)";y.online===null?(C="#94a3b8",L="Aguardando...",P="rgba(255, 255, 255, 0.05)",z="var(--text-muted)",N="rgba(255, 255, 255, 0.1)"):y.online||(C="#ef4444",L="Offline",P="rgba(239,68,68,0.12)",z="#fca5a5",N="rgba(239,68,68,0.3)");const K=R%2===0?"transparent":"rgba(255,255,255,0.015)";R++,F+=`
                <div class="monitor-list-row" style="background: ${K};">
                    <div class="monitor-list-col-name">
                        <span class="monitor-dot" style="background: ${C};"></span>
